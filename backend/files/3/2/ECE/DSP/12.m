%% Design of Chebyshev Filter and Verify Frequency Response
clc;
clear all;
close all;
...
[n, wn] = cheb1ord(w1, w2, rp, rs); % Determine filter order

c = input('Enter choice of Filters: 1.LPF 2.HPF \n'); % Filter type

if c == 1
    disp('Frequency Response of Chebyshev LPF is:');
    [b, a] = cheby1(n, rp, wn, 'low'); % Design Low-Pass Filter
elseif c == 2
    disp('Frequency Response of Chebyshev HPF is:');
    [b, a] = cheby1(n, rp, wn, 'high'); % Design High-Pass Filter
else
...
title('Phase Response of Chebyshev Filter - 22881A0440');
xlabel('Normalized Frequency');
